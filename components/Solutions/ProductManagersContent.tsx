...
const ProductManagersContent: React.FC = () => {
  return (
    <div className="bg-white animate-in fade-in slide-in-from-bottom-4 duration-700">
      {/* Hero Section */}
      <section className="section-padding pt-12 pb-24 lg:pt-34 lg:pb-32 bg-white overflow-hidden">
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-5xl font-extrabold tracking-[-0.03em] leading-[1.05] text-brand-navy">
                  Build product messaging users <span className="text-primary">actually</span> notice
                </h1>
                <p className="text-lg text-gray-500 leading-relaxed max-w-xl">
                  Send transactional alerts, lifecycle nudges, and rich notifications across SMS, WhatsApp, and RCS. Reduce engineering bottlenecks and unify product communication.
                </p>
              </div>
              ...
              <div className="relative w-full aspect-square rounded-3xl bg-gray-50 flex items-center justify-center p-8 lg:p-12 border border-gray-100 shadow-inner">
                ...
                <div className="absolute bottom-12 right-12 bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-2xl border border-white/20">
                  ...
                  <div className="flex justify-between mt-2">
                    <span className="text-[10px] font-bold text-gray-400">72% CTR</span>
                    <span className="text-[10px] font-bold text-gray-400">+12% vs last week</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 w-full">
              <div className="bg-white p-8 lg:p-10 rounded-3xl shadow-xl border border-[#eeeeee]">
                <div className="space-y-8">
                  ...
                  <div className="flex justify-between items-end">
                    <h4 className="font-bold text-sm uppercase tracking-widest text-gray-400">User Retention Lift</h4>
                    <span className="text-3xl lg:text-4xl font-extrabold text-brand-purple">2.4x</span>
                  </div>
                  <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto pt-24 pb-12 px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-[#eeeeee] shadow-sm hover:shadow-md transition-shadow flex flex-col h-full group">
              ...
              <h3 className="text-2xl font-bold text-brand-navy mb-4">Transactional alerts</h3>
              <p className="text-gray-500 leading-relaxed flex-grow">Send mission-critical alerts for payments, logins, and shipping updates with 99.9% deliverability.</p>
              <a className="mt-8 flex items-center gap-2 font-bold text-primary" href="#">
                Learn more <span className="material-symbols-outlined transition-transform group-hover:translate-x-1">arrow_forward</span>
              </a>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-[#eeeeee] shadow-sm hover:shadow-md transition-shadow flex flex-col h-full group">
              ...
              <h3 className="text-2xl font-bold text-brand-navy mb-4">AI-driven support flows</h3>
              <p className="text-gray-500 leading-relaxed flex-grow">Automate complex queries with intelligent chatbots that understand intent across every channel.</p>
              <a className="mt-8 flex items-center gap-2 font-bold text-primary" href="#">
                Learn more <span className="material-symbols-outlined transition-transform group-hover:translate-x-1">arrow_forward</span>
              </a>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-[#eeeeee] shadow-sm hover:shadow-md transition-shadow flex flex-col h-full group">
              ...
              <h3 className="text-2xl font-bold text-brand-navy mb-4">Behavioral nudges</h3>
              <p className="text-gray-500 leading-relaxed flex-grow">Trigger messages based on real-time app actions. Reach users where they are, when it matters.</p>
              <a className="mt-8 flex items-center gap-2 font-bold text-primary" href="#">
                Learn more <span className="material-symbols-outlined transition-transform group-hover:translate-x-1">arrow_forward</span>
              </a>
            </div>
              ...
              <div className="w-full h-full bg-white rounded-[2rem] md:rounded-[2.5rem] overflow-hidden flex flex-col relative pt-10 md:pt-12 p-3 md:p-4">
                <div className="flex items-center gap-3 mb-6">
                  <div className="size-8 md:size-10 rounded-full bg-brand-teal/20 flex items-center justify-center text-primary">
                    <span className="material-symbols-outlined text-lg md:text-xl">account_balance</span>
                  </div>
                  <div className="text-left">
                    <p className="font-bold text-xs md:text-sm text-brand-navy">FinBank Verified</p>
                    <p className="text-[9px] md:text-[10px] text-gray-400">Official Channel</p>
                  </div>
                </div>
                <div className="bg-gray-50 border border-gray-100 rounded-2xl rounded-tl-none p-3 md:p-4 space-y-4">
                  <div className="aspect-video bg-white rounded-xl flex items-center justify-center border border-gray-100 shadow-sm">
                    <div className="text-center">
                      ...
                      <p className="text-[9px] md:text-[10px] font-bold text-gray-400">SECURE TRANSACTION</p>
                    </div>
                  </div>
                  <div className="text-left space-y-1">
                    <div className="flex items-center justify-between">
                      <p className="text-xs font-bold text-brand-navy">Debit Alert: $142.00</p>
                      <span className="bg-blue-50 text-blue-600 text-[8px] font-bold px-1.5 py-0.5 rounded">NEW</span>
                    </div>
                    <p className="text-[10px] md:text-[11px] text-gray-500">Your debit card was used at 'Store NYC'.</p>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <button className="w-full py-2 bg-white border border-primary/20 text-primary font-bold text-[9px] md:text-[10px] rounded-lg">View Receipt</button>
                    <button className="w-full py-2 bg-white border border-red-100 text-red-500 font-bold text-[9px] md:text-[10px] rounded-lg">Report Fraud</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto pt-24 pb-12 px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row-reverse gap-16 lg:gap-20 items-center">
            <div className="flex-1 space-y-8">
              ...
              <p className="text-xl text-gray-600">Sync with your favorite tools. Tracksend integrates deeply with your existing marketing and commerce stack.</p>
              <div className="space-y-6">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="font-bold text-xl text-brand-navy">Onboarding Flows</h4>
                    <p className="text-gray-500">Guide new users to their first "Aha!" moment with well-timed WhatsApp prompts.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="size-14 shrink-0 rounded-2xl bg-white flex items-center justify-center text-brand-purple shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-xl text-brand-navy">Subscription Recovery</h4>
                    <p className="text-gray-500">Automate failed payment recovery with high-urgency RCS notifications.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex-1 w-full">
              ...
              <div className="mt-8 text-center lg:text-left">
                <p className="text-sm font-bold text-brand-purple">Built-in integrations for Customer.io, Klaviyo, WooCommerce, Freshsales, and Mailchimp</p>
              </div>
            </div>
          </div>
        </div>
