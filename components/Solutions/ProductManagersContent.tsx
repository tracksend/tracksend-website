      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <section className="mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Streamline user engagement and communication with Tracksend
            solutions designed for product managers. Launch campaigns, gather
            feedback, and drive adoption effortlessly.
          </p>
