      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5 mb-16">
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold tracking-tight text-white">Tracksend</span>
            </div>
            <p className="text-gray-400 text-sm max-w-xs mb-8">
              Building the future of human-centric B2B communications. Let's grow together.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-white mb-6 text-xs uppercase tracking-widest">Product</h4>
            <ul className="space-y-4 text-sm text-gray-400">
              <li><a className="hover:text-primary transition-colors" href="#">Messaging API</a></li>
              <li><a className="hover:text-primary transition-colors" href="#">WhatsApp Flows</a></li>
              <li><Link className="hover:text-primary transition-colors" href="/pricing">Pricing</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-white mb-6 text-xs uppercase tracking-widest">Developers</h4>
            <ul className="space-y-4 text-sm text-gray-400">
              <li><a className="hover:text-primary transition-colors" href="#">API Docs</a></li>
              <li><a className="hover:text-primary transition-colors" href="#">SDKs & Libraries</a></li>
        ...
        <div className="border-t border-gray-800 pt-10 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Johannesburg</div>
            <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Lagos</div>
            <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">San Francisco</div>
          </div>
        </div>
      </div>
    </footer>
