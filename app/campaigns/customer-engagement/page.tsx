        ...
        <section className="relative isolate pt-36 pb-24 lg:pt-48 lg:pb-32">
          ...
          <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
            <div>
              ...
              <Link href="https://cal.com/nkechiogbons/discovery-onboarding" className="mt-10 inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-8 py-4 font-black text-navy shadow-lg shadow-cyan-200 transition hover:-translate-y-0.5 hover:shadow-xl">
        ...
        <section className="px-6 pb-24 lg:px-8 lg:pb-32">
          <div className="relative mx-auto max-w-4xl overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white px-7 py-14 text-center shadow-xl shadow-slate-200/60 sm:px-12 lg:px-20 lg:py-18">
            ...
            <div className="relative">
              ...
              <Link href="https://cal.com/nkechiogbons/discovery-onboarding" className="mt-8 inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-8 py-4 font-black text-navy shadow-lg shadow-cyan-200 transition hover:scale-105">
                Book a Call <ArrowRight className="size-5" />
              </Link>
